...
//! @}
// SAL2 Definitions
// 修改: MinGW环境下也使用自定义SAL注解（MinGW没有MSVC的specstrings.h完整定义）
...
// MinGW: noexcept in function pointer types causes "declared as function returning a function" error
// MinGW 7.3 (GCC 7.3) does not properly support noexcept in function pointer member declarations
#define NO_EXCEPTION
#elif ((__cplusplus >= 201103L) || (_MSC_VER >= 1900) || (defined(__has_feature) && __has_feature(cxx_noexcept)))
